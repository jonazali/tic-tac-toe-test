 ...
 */
exports.nextPlayer = currPlayer => (currPlayer === 'X' ? 'O' : 'X');
 ...
 * @returns {void}
 */
exports.play = (board = generateStartingBoard(), player = 'X') => {
  ...
  return exports.play(updatedBoard, exports.nextPlayer(player));
};
